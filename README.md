# D-Study 작업 현황
## 일자 : 2024년 8월 8일 (목)
![Test Image](test_Image2.png)


1차 라벨링 단계 

     1. 1차 형태소 분리 __df ['processed_text']__

     2. 1차 필터링 후 형태소 분리 __df['final_processed_text']__

     3. 1차 필터링 후 형태소의 병합하여 텍스트 저장 __df ['1st_filtering_text']__
